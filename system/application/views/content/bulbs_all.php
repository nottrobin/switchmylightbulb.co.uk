    <h1>All regular bulbs</h1>
    
    <p>This is a list of all regular bulbs in our database. You can see replacements for any bulb in the list by clicking the links on the right.</p>
    ...
    <?php else: ?>
    <p>Sorry there don't appear to be any bulbs in our database.</p>
    <?php endif ?>
